package com.mad.shopping_mall.adapter;
...
public class HotGridViewAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            holder = ( com.mad.shopping_mall.adapter.CommodityViewHolder) convertView.getTag();
        }
